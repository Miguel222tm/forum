...
<head>
	<meta charset="UTF-8">
	<title>uuorkstore</title>

	<meta name="description" content="u+us, getting a job couldn't be easier.">

	<meta name="uuorkstore" content="Startup HTML template, Bootstrap Agency theme, html template, charity template, premium html template, one page template">

	<meta name="author" content="Miguel Trevino">
			...
			<nav class="main-navigation navbar-fixed-top" role="navigation" data-spy="affix" data-offset-top="200">
				<div class="container">
					<div class="navbar-header">
						...
						<!-- logo here -->
						<a href="index.html" class="navbar-brand"><span>UU</span>ORK<span>S</span>TORE</a>
					</div>
		...
		<section id="intro" class="section-intro">
			<div class="overlay">
				<div class="container">
					<div class="row">
						<div class="main-text">
							<h1 class="wow fadeInUp"><span>UU</span>ORK<span>S</span>TORE</h1>
							<h2 class="wow fadeInUp" data-wow-delay=".7s">Getting a job couldn't be easier. </h2>
							<div class="wow fadeInUp" data-wow-delay="1.5s"><a onclick="smoothScr.anim('services')" class="btn btn-border btn-lg"><i class="fa fa-spinner fa-spin"></i> SITE IN CONSTRUCTION</a></div>
						</div>
					</div>
				</div>
			</div>
		...
		<section id="connected">
			<div class="container">
				<div class="row">
					...
					<h3 class="discription wow fadeIn" data-wow-delay=".2s">We are working to make this project done as soon as possible.</h3>
					<hr>
					<div class="connected-wrapper text-center">
						<div class="col-sm-6 col-md-3 wow fadeInUp" align="center" data-wow-delay="0.2s">
							<div class="contact-item" >
								<a href="#"><i class="fa fa-user"></i></a>
								<h5>Support Team</h5>
								<h4>support@uuokstore.com</h4>
							</div>
						</div>
					</div>
				</div>
